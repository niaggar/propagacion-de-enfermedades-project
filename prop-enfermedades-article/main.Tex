...
% \begin{figure}[h]
% 	\centering
% 	\includegraphics[width=0.5\textwidth]{simulacion1.png}
...
El \textit{gif} se puede observar en la siguiente dirección \href{https://github.com/niaggar/propagacion-de-enfermedades-project}{Propagacion
de enfermedades} el cual se encuentra tambien dentro del repositorio \cite{GitHub}.
