...
Por otra parte los demás modelos \textit{SIRS} y \textit{SIRS} con vacunación, presentan curvas más "suaves", y con picos más bajos en genera.
Un caso particular es cuando el modelo \textit{SIRS} con vacunación, que bajo las mismas condiciones del pico más bajo del modelo \textit{SIR},
se consigue la grafica \ref{fig:SIRS-VAC2}, que tambien causa que las poblaciones de susceptibles y removidos, se queden en un punto intermedio,
